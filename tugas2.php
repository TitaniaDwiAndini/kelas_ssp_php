...
<?php
    ...
    if (isset($_POST['cmdkirim'])){
        echo "<h2 style='font-family:Arial'>Hai... ".$nama.", kamu jurusan ".$jur." di Institut Asia Malang ya..., kamu ".$jk." yang rumahnya di ".$alm.". O ya, NIM mu ".$nim."kan...... Selamat belajar ya....</h2>";
    }
?>
</body>
</html>